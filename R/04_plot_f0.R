...
png("output/figures/f0_credible_bands.png", width = 1500, height = 1050, res = 200)
...
plot(agrid, bq[1,], type = "n", ylim = ylim,
     ...
     main = "SPM optimal trajectory f0(t): Bayesian credible band vs ML vs truth")
...
legend("topleft", bty = "n",
       ...
       lwd = c(2.5, 8, 2, 2.5), lty = c(1, 1, 2, 3))
dev.off()
